...
if (NOT MATLAB_ROOT)
    ...
    find_program(MATLAB_EXE_PATH matlab
            PATHS /usr/local/MATLAB/R2016b/bin)
    if (MATLAB_EXE_PATH)
        ...
        elseif(${CMAKE_SYSTEM_NAME} MATCHES "Darwin")   # Check if this is a Mac
            ...
            # Search for a version of Matlab available, starting from the most modern one to older versions
            foreach(MATVER "R2015b" "R2015a" "R2014b" "R2014a" "R2013b" "R2013a" "R2012b" "R2012a" "R2011b" "R2011a" "R2010b" "R2010a" "R2009b" "R2009a" "R2008b" "R2016b")
